...
if __name__ == "__main__":
    ...
    point2 = [0.5, 0., 0.4]  # 第二个点的位置 [x, y, z]
    ...
    try:
        while not rospy.is_shutdown():
            # 移动到第一个点
            rospy.loginfo("Moving to point 1 base line...")
            ...
            # 移动到第二个点
            rospy.loginfo("Moving to point 2 base circle...")
            # grasp_demo.movel(point2, orientation2)
            grasp_demo.moveC(point2, orientation2)
